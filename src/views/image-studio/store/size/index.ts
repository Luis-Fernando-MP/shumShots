...
const STORAGE_KEY = 'pixis:image-studio:size'
const STORAGE_VERSION = 1

const clampSize = (value: number) => Math.min(4000, Math.max(100, Math.round(value)))

const createLayer = (id?: string): SizeLayer => ({
  id: id ?? createId('size'),
  targetIds: [],
