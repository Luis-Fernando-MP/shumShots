      ...
      {mounted &&
        createPortal(
          <article
            ...
            className={cn(
              'popup border-border/40 bg-card/80 fixed flex min-h-[300px] min-w-[200px] flex-col overflow-hidden rounded-lg border backdrop-blur-md select-none',
            ...
            style={{
              left: `${position.x}px`,
              top: `${position.y}px`,
              zIndex: APP_Z_INDEX.studio.popup
            }}
          >
            {headers}
            {contents}
